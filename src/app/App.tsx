...
import {
  ...
  imgFrame2,
  imgHeaderOverlay,
  img3DiconsWreathDynamicPremium,
  img3DiconsXmasTreeDynamicPremium,
  img3DiconsXmasTreeDynamicPremium1,
  img3DiconsGiftDynamicPremium,
  img3DiconsLeafDynamicPremium,
  img3DiconsPictureDynamicPremium,
  imgBit1,
  imgBit2,
  imgBit3,
  imgBit4,
...
// suppress unused-variable warning for imgHeaderOverlay (kept for future use)
void imgHeaderOverlay;
